    ...
    >
      ...
      <DialogActions sx={{ px: 3, py: 2, gap: 1 }}>
        ...
        <Button
          ...
          startIcon={
            creando ? <CircularProgress size={14} color="inherit" /> : undefined
          }
          sx={{
            bgcolor: "#1E293B",
            borderRadius: 2,
...
export default ModalCrearAyudantia;
